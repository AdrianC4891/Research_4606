    ...
    methods (Access=protected)
        ...
        function [output, syncInd, phaseEst] = stepImpl(obj, input,...
            ...
            for k = 1:length(input)/sps
                ...
                filtOut =  obj.pRecFilter(complex(filtIn));
            ...
            if frameSyncStat
                ...
                if symbolCount > obj.pFullFrameSize-90
                    ...
                    elseif any(iscont)  
                        ...
                        newSync = possSyncInd(2,:) > obj.FrameSyncAveragingFrames/2;
                        if any(newSync)
                             syncInd = possSyncInd(1,newSync);
                             possSyncInd = zeros(2,10,obj.pInputDataType);
                        end
                    end 
                end
            ...
            if obj.pFrameCount >=  ...
                ...
                if obj.pSyncIndex <= 0
                    obj.pSyncIndex = obj.pFullFrameSize+obj.pSyncIndex;
                end
            end
        ...
        function processTunedPropertiesImpl(obj)
            ...
            obj.pIntegratorGain = 4*obj.pCarrSyncLoopBW;
        end
